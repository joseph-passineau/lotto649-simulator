...
test('2 matching numbers should win', () => {
  ...
  const ticket = new Ticket([winningNumbers[0], winningNumbers[1], loosingNumber[0], loosingNumber[1], loosingNumber[2], loosingNumber[3]]);
  const winnings = lottery.validateTicket(ticket);
...
test('2 matching numbers + bonus should win', () => {
  ...
  const ticket = new Ticket([winningNumbers[0], winningNumbers[1], bonusNumber, loosingNumber[1], loosingNumber[2], loosingNumber[3]]);
  const winnings = lottery.validateTicket(ticket);
...
test('3 matching numbers should win', () => {
  ...
  const ticket = new Ticket([winningNumbers[0], winningNumbers[1], winningNumbers[2], loosingNumber[1], loosingNumber[2], loosingNumber[3]]);
  const winnings = lottery.validateTicket(ticket);
...
test('4 matching numbers should win', () => {
  ...
  const ticket = new Ticket([winningNumbers[0], winningNumbers[1], winningNumbers[2], winningNumbers[3], loosingNumber[2], loosingNumber[3]]);
  const winnings = lottery.validateTicket(ticket);
...
test('5 matching numbers should win', () => {
  ...
  const ticket = new Ticket([winningNumbers[0], winningNumbers[1], winningNumbers[2], winningNumbers[3], winningNumbers[4], loosingNumber[3]]);
  const winnings = lottery.validateTicket(ticket);
...
test('5 matching numbers + bonus should win', () => {
  ...
  const ticket = new Ticket([winningNumbers[0], winningNumbers[1], winningNumbers[2], winningNumbers[3], winningNumbers[4], bonusNumber]);
  const winnings = lottery.validateTicket(ticket);
...
test('6 matching numbers should win', () => {
  ...
  const ticket = new Ticket([winningNumbers[0], winningNumbers[1], winningNumbers[2], winningNumbers[3], winningNumbers[4], winningNumbers[5]]);
  const winnings = lottery.validateTicket(ticket);
...
test('0 matching numbers should lose', () => {
  ...
  const ticket = new Ticket([loosingNumber[0], loosingNumber[1], loosingNumber[2], loosingNumber[3], loosingNumber[4], loosingNumber[5]]);
  const winnings = lottery.validateTicket(ticket);
